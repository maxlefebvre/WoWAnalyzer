...
import DebuffStackTracker from './DebuffStackTracker';
...
export default abstract class DebuffStackGraph extends Analyzer {
  abstract tracker(): DebuffStackTracker;

  get plot() {
    const graphData: GraphData[] = [];
    const tracker = this.tracker();

    tracker.debuffStackUpdates.forEach((tb) => {
      if (tb.change !== 0) {
